    ...
    <Container>
      ...
      >
        ...
        >
          ...
          <h2>
            <span style={{ color: "#7764E8" }}> PickGo </span> Planner
        ...
        <StyledMenuItem
          translate="no"
          onClick={() => {
            window.open("https://github.com/Bouzayenilyes/PickGo_Planner");
          }}
        >
          <GitHub /> &nbsp; Github{" "}
          {stars && (
        ...
        <StyledMenuItem
          onClick={() => {
            window.open("https://github.com/Bouzayenilyes/PickGo_Planner/issues/new");
          }}
        >
